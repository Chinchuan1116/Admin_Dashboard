  ...
  return (
    <div className='mt-12'>
      <div className='flex flex-wrap justify-center'>
        <div className='bg-white text-gray-200 dark:bg-secondary-dark-bg h-44 ml-2 rounded-xl w-full p-8 pt-4 m-3 bg-hero-pattern bg-no-repeat bg-cover bg-center'>
